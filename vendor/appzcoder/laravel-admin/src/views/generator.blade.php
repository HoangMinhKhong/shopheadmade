                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" method="post" action="{{ url('/admin/generator') }}">
                            ...
                            <div class="form-group">
                                <label for="crud_label" class="col-md-4 control-label">Crud Label:</label>
                                <div class="col-md-6">
                                    <input type="text" name="crud_label" class="form-control" id="crud_label" placeholder="Crud Label" required="true">
                                </div>
                            </div>
                            <div class="form-group">
