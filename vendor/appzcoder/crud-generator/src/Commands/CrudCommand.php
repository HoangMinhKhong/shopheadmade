...
class CrudCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $this->call('crud:view', ['name' => $name, '--label' => $label,  '--fields' => $fields, '--validations' => $validations, '--view-path' => $viewPath, '--route-group' => $routeGroup, '--localize' => $localize, '--pk' => $primaryKey]);
        if ($localize == 'yes') {
    ...
    {
        return [
        	"Route::post('" . $this->routeName . "/batch-remove', '" . $this->controller . "@batchRemove');",
