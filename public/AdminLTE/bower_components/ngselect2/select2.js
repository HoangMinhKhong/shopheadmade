...
(function ($, undefined) {
    ...
    function syncCssClasses(dest, src, adapter) {
        ...
        if (classes) {
            classes = '' + classes; // for IE which returns object
            $(classes.split(" ")).each2(function() {
	        // D2T Start Fixbug add validate to select 2
                if (this.indexOf("validate[") === 0) {
                    //Nothing
                } else if (this.indexOf("select2-") !== 0) {
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        init: function (opts) {
            ...
            //D2T START remove class validate[required] sau khi hệ thống tự động copy toàn bộ class của select lên thẻ div 
