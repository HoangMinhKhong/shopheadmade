    ...
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <a href="{{ url('/admin/permissions/create') }}" class="btn btn-success btn-sm" title="Thêm mới Permission">
                    ...
                    <table class="table table-borderless">
                        ...
                        @foreach($permissions as $item)
                            <tr>
                                ...
                                <td width="150">
                                    <a href="{{ url('/admin/permissions/' . $item->id) }}" title="View Permission"><button class="btn btn-info btn-xs"><i class="fa fa-eye" aria-hidden="true"></i> Xem</button></a>
                                    @if(\Auth::user()->can('permissions_edit') || \Auth::user()->hasRole('administrator'))
                                    <a href="{{ url('/admin/permissions/' . $item->id . '/edit') }}" title="Edit Permission"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Sửa</button></a>
                                    @endif
                                    @if(\Auth::user()->can('permissions_delete') || \Auth::user()->hasRole('administrator'))
                                    {!! Form::open([
