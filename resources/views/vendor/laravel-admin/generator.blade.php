                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" method="post" action="{{ url('/admin/generator') }}">
                            ...
                            <div class="form-group">
                                <label for="crud_name" class="col-md-3 control-label">Crud Name:</label>
                                <div class="col-md-4">
                                    <input type="text" name="crud_name" class="form-control" id="crud_name" placeholder="Posts" required="true">
                                </div>

                                <div class="col-md-5">
                                    <input type="text" name="crud_label" class="form-control" id="crud_label" placeholder="Bài viết" required="true">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="controller_namespace" class="col-md-3 control-label">Controller Namespace:</label>
                                <div class="col-md-6">
                                    <input type="text" name="controller_namespace" class="form-control" id="controller_namespace" placeholder="Admin">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="route_group" class="col-md-3 control-label">Route Group Prefix:</label>
                                <div class="col-md-6">
                                    <input type="text" name="route_group" class="form-control" id="route_group" placeholder="admin">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="view_path" class="col-md-3 control-label">View Path:</label>
                                <div class="col-md-6">
                                    <input type="text" name="view_path" class="form-control" id="view_path" placeholder="admin">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="route" class="col-md-3 control-label">Want to add route?</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group table-fields">
                                ...
                                <div class="entry col-md-10 col-md-offset-2 form-inline">
                                    ...
                                    <input class="form-control" name="label[]" type="text" placeholder="field_label" required="true">
