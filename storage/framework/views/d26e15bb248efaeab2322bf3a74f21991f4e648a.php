    ...
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <a href="<?php echo e(url('/admin/bookmark/create')); ?>" class="btn btn-success btn-sm" title="Thêm mới Permission">
                ...
                <?php echo Form::open(['method' => 'GET', 'url' => '/admin/bookmark', 'class' => 'navbar-form navbar-right', 'role' => 'search']); ?>
                ...
                <div class="table-responsive">
                    <table class="table table-borderless">
                        ...
                        <tbody>
                        <?php $__currentLoopData = $bookmark; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <?php if(\Auth::user()->can('bookmark_delete') || \Auth::user()->hasRole('administrator')): ?>
                                <td width="50">
                                ...
                                <?php endif; ?>
                                <td><a href="<?php echo e(url('/admin/bookmark', $item->id)); ?>"><?php echo e($item->name); ?></a></td>
                                <td><?php echo e($item->price); ?></td>
                                <td><?php echo e($item->retail_price); ?></td>
                                <td width="150">
                                    <a href="<?php echo e(url('/admin/bookmark/' . $item->id)); ?>" title="View Permission"><button class="btn btn-info btn-xs"><i class="fa fa-eye" aria-hidden="true"></i> Xem</button></a>
                                    <?php if(\Auth::user()->can('bookmark_edit') || \Auth::user()->hasRole('administrator')): ?>
                                    <a href="<?php echo e(url('/admin/bookmark/' . $item->id . '/edit')); ?>" title="Edit Permission"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Sửa</button></a>
                                    <?php endif; ?>
            ...
            <div class="box-footer clearfix">
                ...
                <?php echo $bookmark->appends(['search' => Request::get('search')])->render(); ?>
