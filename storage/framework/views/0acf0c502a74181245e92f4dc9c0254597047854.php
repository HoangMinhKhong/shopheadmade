...
<li><a href="<?php echo e(url('/admin/bookmark')); ?>">Bookmark</a></li>
    ...
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <?php echo Form::open(['url' => '/admin/bookmark', 'class' => 'form-horizontal', 'id' => 'frmSave' ]); ?>


                <?php echo $__env->make('admin.backend.bookmark.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
