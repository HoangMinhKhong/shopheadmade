    ...
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <a href="<?php echo e(url('/admin/users/' . $user->id . '/edit')); ?>" title="Sửa User"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Sửa</button></a>
                <?php endif; ?>
                ...
                <button type="submit" class="btn btn-danger btn-xs" title="Xóa" onclick="return d2tConfirmDelete(function(){
                            $('#frmDelete_<?php echo e($user->id); ?>').submit();
                        });">
...
app.controller('usersController', ['$scope', '$http', '$filter', function($scope, $http, $filter) {
    $scope.objData = <?php echo json_encode($user); ?>;
}]);
</script>
<?php $__env->stopSection(); ?>
